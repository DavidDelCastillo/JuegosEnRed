class PauseLoScene extends Phaser.Scene {
    constructor() {
        super({ key: 'PauseLoScene' });
    }
    ...
    create() {
        ...
        const reanudar = this.add.image(0.28 * centerX, 0.4 * centerY, "reanudar").setInteractive()
            .on('pointerdown', () => {
                this.scene.stop("PauseLoScene");//Detiene la escena
