...
export default class GameLoScene extends Phaser.Scene {
    constructor() {
        super({ key: 'GameLoScene', physics: { default: 'arcade' } });
    }
    ...
    create() {
        ...
        const pausa = this.add.image(1.5 * centerX, 0.55 * centerY, 'pause').setScrollFactor(0).setScale(0.09)
            ...
            .on('pointerdown', () => {
                ...
                this.scene.launch('PauseLoScene', { callingScene: this.scene.key }); //Nos movemos a la escena de pausa
            });
        ...
        this.physics.add.collider(this.sighttail, this.carta, () => {
            ...
            this.time.delayedCall(500, () => {
                this.scene.stop("GameLoScene");
                this.scene.start("EndLoScene");
            });
        })
...
launchDialogueScene(caseId) {
    ...
    this.scene.pause();
    this.scene.launch('DialogueLoScene', { startIndex, endIndex, callingScene: this.scene.key });
}
